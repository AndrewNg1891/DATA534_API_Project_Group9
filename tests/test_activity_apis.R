...
test_that('test_get_organization_events returns correct length list.', {
  expect_length(github_get_organization_events("repository",102,"WestHealth","pyvis"), 2)
})
...
test_that('test_github_lastn_events_df returns list.',{
  expect_equal(typeof(github_github_lastn_events_df("organization",102,organization="ubco-mds-2021")), "list")
})
